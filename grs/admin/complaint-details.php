...
<button type="button" class="btn btn-primary" id="Printbtn" onClick="PrintComplaint('content')">Print Complaint</button></a></td>
<script>
...
<?php include('include/footer.php');?>
	...
	<script src="bootstrap/js/printer.js" type="text/javascript"></script>
