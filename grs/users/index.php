...
return true;
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
	  		<h3 align="center" style="color:#fff"><a href="../index.html" style="color:#fff">Grievance Redressal System- GOVERNMENT POLYTECHNIC AWASARI(KH)</a></h3>
	<hr />
...
<!-- Footer --><center>
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy;  Team Grievance Redressal System- GP AWASARI 2024</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
